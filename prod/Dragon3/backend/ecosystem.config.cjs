  ...
  apps: [
    ...
    // =================================================================
    {
      ...
      env: {
        ...
        REDIS_PORT: 6379,
        REDIS_PASSWORD: 'mFSv55LIO5/0R/0hrzuth+tw3hmtMTbT',
        REDIS_DB: 1,
        JWT_SECRET: 'DrAgOn3_2025_S3cUr3_K3y_9f8d7a6b5c4e3f2a1b0c9d8e7f6a5b4c3d2e1f0a9b8c7d6e5f4a3b2c1d0',
        MONGO_URI: 'mongodb+srv://gustavoherraiz:Lobosolitario@proyectodragon.yvzan.mongodb.net/dragon?retryWrites=true&w=majority&appName=ProyectoDragon'
      },
