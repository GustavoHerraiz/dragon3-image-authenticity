...
- **Prueba de carga síncrona 2026-09-09:** escalones `1/2/4/8`, 15/15 análisis `200` y `completado`, 0 errores, 0 rechazos y 0 reinicios. El primer análisis tardó 14,8 s por arranque frío; en warm, el p95 a concurrencia 8 fue 3,13 s. Embassy alcanzó aproximadamente 302 MB RSS y el host conservó aproximadamente 595 MiB disponibles. El cuello principal detectado no fue Bull DB2: Redis DB1 contiene un stream `dragon3:stream:req:superior` de aproximadamente 429,5 MB por payloads binarios sin retención acotada.
- **Prueba sostenida 2026-09-09:** se intentó mantener 1 análisis/segundo con máximo 4 simultáneos durante 30 minutos, pero la protección detuvo la prueba a los 1,84 minutos al bajar la memoria disponible a 261 MiB. Los 10 análisis completados fueron correctos, pero p95/p99 subieron a 98,5 s; el async-worker creció aproximadamente de 51 a 158 MiB RSS. No se certifica capacidad sostenida hasta aislar ese crecimiento y reducir memoria por análisis.
