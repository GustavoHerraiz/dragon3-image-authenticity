...
- **Siguiente gate:** activar Prometheus con esos artefactos y ejecutar una ventana sostenida de 30 minutos antes de escalar gradualmente `DRAGON3_ASYNC_WORKERS`/`ASYNC_QUEUE_CONCURRENCY` o declarar capacidad Enterprise.
...
**Gate:** auditoria de seguridad sin hallazgos criticos y pruebas de autorizacion entre tenants satisfactorias.
