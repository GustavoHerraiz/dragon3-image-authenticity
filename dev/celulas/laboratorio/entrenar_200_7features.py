...
# 3. Entrenar modelo con pipeline
...
# 6. Validación cruzada (5 folds) para robustez
...
df_resultados.to_csv('resultados_200_7features.csv', index=False)
print('📁 Métricas guardadas en resultados_200_7features.csv')

# 10. Guardar figura de importancia
plt.figure(figsize=(10, 6))
plt.barh(feature_names[idx[:15]], importances[idx[:15]])
plt.xlabel('Importancia Gini')
plt.title('Top 15 features (7 features group)')
plt.tight_layout()
plt.savefig('importancia_features_200.png', dpi=150)
print('📁 Figura guardada en importancia_features_200.png')
