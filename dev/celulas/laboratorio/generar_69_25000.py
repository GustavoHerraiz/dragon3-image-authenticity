...
def generar_dataset():
    print("=" * 80)
    print("GENERACIÓN DE 25000 MUESTRAS (69 features)")
    print("=" * 80)
    ...
    if len(X_list) < 25000:
        print(f"❌ Solo se obtuvieron {len(X_list)} muestras (<25000).")
        sys.exit(1)
    ...
    np.save(os.path.join(LAB_DIR, "X_69_25000.npy"), X)
    np.save(os.path.join(LAB_DIR, "y_69_25000.npy"), y)

    print("\n💾 Archivos guardados en:")
    print(f"   {os.path.join(LAB_DIR, 'X_69_25000.npy')}")
    print(f"   {os.path.join(LAB_DIR, 'y_69_25000.npy')}")
    print("\n✅ Ahora ejecuta: python analisis_xgboost_25000.py")
